...
scale_colour_manual(values=bluegreen,na.value = "grey50",name  ="median longevity",labels = c("14", "15", "16", "17", "18", "19+"))+
...
ggsave("/home/julian/Documents/WGFBIT/Norway/MAREANO_beam_longevity.png", plot = figmap, width = 15, height = 13, units = "cm")


## State 2018

#   quat<-c(0,0.1,0.3,0.5,0.7,0.9,1.01)
#     gr$cat<- as.factor(cut(gr$rbs2018,quat,right=FALSE))

gr$cat <- as.factor(floor(gr$rbs2018 * 10 / 2))

figmap <- ggplot() +
  geom_point(data=gr, aes(x=lon, y=lat, colour=cat),shape=15,size = 1,na.rm=T) +
...
ggsave(filename = "/home/julian/Documents/WGFBIT/Norway/MAREANO_beam_state_2018.png", plot = figmap, width = 15, height = 13, units = "cm")
...
ggsave("/home/julian/Documents/WGFBIT/Norway/MAREANO_SAR_2018.png", plot = figmap, width = 15, height = 13, units = "cm")
