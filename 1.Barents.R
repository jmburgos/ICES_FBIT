...
sa <- read_sf("/home/julian/Documents/WGFBIT/Barents_Sea/study_area/study_area.shp")
...
grain <- read_sf("/home/julian/Documents/WGFBIT/NGU_Sediments/Barents_regional/NGU_MarineBunnsedimenter_kornstr_oversikt/KornstorrelseFlate_oversikt.shp") %>%
