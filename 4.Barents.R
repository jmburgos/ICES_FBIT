...
load(file = "/home/julian/Documents/WGFBIT/Barents_Sea/dt.Rdata")
...
save(modcoeff,file="/home/julian/Documents/WGFBIT/Barents_Sea/Coefficients_Bdata.RData")
